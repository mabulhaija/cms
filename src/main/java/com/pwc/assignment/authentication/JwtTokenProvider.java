...
public class JwtTokenProvider {
    ...
    public static SystemUser extractUserData(HttpServletRequest request) {
        return ((AuthenticationUser) ((UsernamePasswordAuthenticationToken) request.getUserPrincipal()).getPrincipal()).getSystemUser();
    }
}
